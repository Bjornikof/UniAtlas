...
class Faculties(models.Model):
    ...
    edu_field = models.CharField(choices=EDU_FIELD_CHOICES, default=None, max_length=100)
...
class Department(models.Model):
    ...
    name = models.CharField(max_length=100)
    total_year = models.CharField(choices=TOTAL_YEAR_CHOICES, max_length=100)
    scholarship = models.IntegerField(choices=SCHOLARSHIP_CHOICES, default=-1)
    score = models.FloatField(default=0, validators=[MaxValueValidator(600), MinValueValidator(0)])
